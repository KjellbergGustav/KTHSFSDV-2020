...
$ python main.py
```
The program will now run, first asking you what you want `t_0` to be, keep in mind that this is defined as an integer. Second, it will prombt you to enter `t_n`, i.e the integer `t` you want the function to stop at. Each step size is 0.01.
